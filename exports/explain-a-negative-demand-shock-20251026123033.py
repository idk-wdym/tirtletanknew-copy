"""
        ...
        Run:
            manim -pqh explain-a-negative-demand-shock-20251026123033.py EconScene  # preview
            manim -p -r 1920,1080 -q h explain-a-negative-demand-shock-20251026123033.py EconScene  # full quality
        """
        from manim import *
        import numpy as np
  ...
  },
  {
    ...
    "narration": "Annotate the new equilibrium with lower price and quantity."
        ...
        # import json
        # with open("explain-a-negative-demand-shock-20251026123033.json", "r", encoding="utf-8") as fh:
        #     BEATS = json.load(fh)
