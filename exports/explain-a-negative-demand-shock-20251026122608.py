        ...
        Run:
            manim -pqh explain-a-negative-demand-shock-20251026122608.py EconScene  # preview
            manim -p -r 1920,1080 -q h explain-a-negative-demand-shock-20251026122608.py EconScene  # full quality
        """
        from manim import *
        import numpy as np
  ...
  },
  {
    ...
    "narration": "Annotate the new equilibrium with lower price and quantity."
        ...
        # import json
        # with open("explain-a-negative-demand-shock-20251026122608.json", "r", encoding="utf-8") as fh:
        #     BEATS = json.load(fh)
        ...
        def axes_with_labels():
            ...
            labels = axes.get_axis_labels(x_label="Quantity", y_label="Price")
            return axes, labels
